# Create the core modules directory structure and files
...
for directory in ['core', 'gui', 'utils', 'tests']:
    init_file = os.path.join(directory, '__init__.py')
    with open(init_file, 'w') as f:
        f.write(f'"""{"Core" if directory == "core" else directory.capitalize()} modules for Cogni-Flow application."""\n')

print("✅ Created directory structure")

# Create core/text_processor.py - LLM integration and text processing
...
# Save core/text_processor.py
with open('core/text_processor.py', 'w', encoding='utf-8') as f:
    f.write(text_processor_content)

print("✅ Created core/text_processor.py")